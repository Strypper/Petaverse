...
public sealed partial class AddPetContentDialog : ContentDialog, INotifyDataErrorInfo
{
    ...
    [ObservableProperty]
    private ObservableCollection<Models.DTOs.Animal> ownedPets = new ObservableCollection<Models.DTOs.Animal>();

    [ObservableProperty]
    private CreatePetDTO petInfo = new CreatePetDTO();

    [ObservableProperty]
    private ObservableCollection<Models.DTOs.Species> species = new ObservableCollection<Models.DTOs.Species>();
    ...
    [ObservableProperty]
    Models.DTOs.Breed selectedBreed;

    partial void OnSelectedBreedChanged(Models.DTOs.Breed value)
    {
...
public class BreedToColorConverter : IValueConverter
{
    public object Convert(object value, Type targetType, object parameter, string language)
    {
        var breed = (Models.DTOs.Breed)value;
        return breed != null
...
public class BreedToBreedIdConverter : IValueConverter
{
    public object Convert(object value, Type targetType, object parameter, string language)
    {
        ...
        var breedCollection = (List<Models.DTOs.Breed>)parameter;
...
public class SpeciesToColorConverter : IValueConverter
{
    public object Convert(object value, Type targetType, object parameter, string language)
    {
        var species = (Models.DTOs.Species)value;
        if (species != null)
        {
