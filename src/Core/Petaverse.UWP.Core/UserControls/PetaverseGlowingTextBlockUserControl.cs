...
public sealed class PetaverseGlowingTextBlockUserControl : UserControl
{
    public string Text
    {
    ...
    public static readonly DependencyProperty TextProperty =
        DependencyProperty.Register(
            "Text",
            typeof(string),
            typeof(PetaverseGlowingTextBlockUserControl),
    ...
    public static readonly DependencyProperty TextFontSizeProperty =
            DependencyProperty.Register(
                ...
                typeof(double),
                typeof(PetaverseGlowingTextBlockUserControl),
                new PropertyMetadata(14.0, new PropertyChangedCallback(OnPropertyChanged)));
    ...
    public PetaverseGlowingTextBlockUserControl()
    {
    ...
    {
        var instance = d as PetaverseGlowingTextBlockUserControl;
        if (d == null)
            return;
    ...
    private CanvasTextLayout CreateTextLayout(ICanvasResourceCreator resourceCreator, Size size)
    {
        ...
        {
            FontSize = (float)TextFontSize, // Use the FontSize property
